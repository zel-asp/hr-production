...
<?php foreach ($hcmEmployees as $employee): ?>
    <div id="employeeModal<?= $employee['id'] ?>"
        ...
        <div class="bg-white rounded-xl max-w-4xl w-full mx-4 shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
            ...
            <div class="flex justify-around items-center px-6 py-4 border-b border-gray-100 sticky top-0 bg-white z-10">
                <div class="flex items-center gap-3">
                    <h3 class="text-lg font-semibold text-gray-900">
                        <i class="fa-solid fa-user mr-2 text-blue-600"></i>
                        Employee: <?= htmlspecialchars($employee['full_name'] ?? '') ?>
                    </h3>
                    <span
                            ...
                            foreach ($timeline as $event):
                                ...
                                <div class="flex gap-3">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="w-8 h-8 bg-<?= $event['color'] ?>-100 rounded-full flex items-center justify-center">
                                            <i
                                                class="fa-solid <?= $event['icon'] ?> text-<?= $event['color'] ?>-600 text-xs"></i>
                                        </div>
                                    </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-2 gap-3">
                                        ...
                                        <div>
                                            ...
                                            <?php if (!empty($employee['resume_path']) || !empty($employee['resume'])): ?>
                                                <span class="text-xs text-green-600"><i
                                                        class="fa-solid fa-check-circle mr-1"></i>Uploaded</span>
                                            <?php else: ?>
                            ...
                            <div class="bg-gray-50 rounded-lg border border-gray-200 p-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <?php if (!empty($employee['nbi_clearance'])): ?>
                                        <a href="<?= htmlspecialchars($employee['nbi_clearance']) ?>" target="_blank"
                                            class="text-xs text-blue-600 hover:text-blue-800 bg-white px-2 py-1 rounded border border-blue-200 hover:bg-blue-50 transition">
                                            <i class="fa-solid fa-eye mr-1"></i> View
                                        </a>
                                    <?php endif; ?>
                            ...
                            <div class="bg-gray-50 rounded-lg border border-gray-200 p-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <?php if (!empty($employee['medical_result'])): ?>
                                        <a href="<?= htmlspecialchars($employee['medical_result']) ?>" target="_blank"
                                            class="text-xs text-blue-600 hover:text-blue-800 bg-white px-2 py-1 rounded border border-blue-200 hover:bg-blue-50 transition">
                                            <i class="fa-solid fa-eye mr-1"></i> View
                                        </a>
                                    <?php endif; ?>
                            ...
                            <div class="bg-gray-50 rounded-lg border border-gray-200 p-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <?php if (!empty($employee['birth_certificate'])): ?>
                                        <a href="<?= htmlspecialchars($employee['birth_certificate']) ?>" target="_blank"
                                            class="text-xs text-blue-600 hover:text-blue-800 bg-white px-2 py-1 rounded border border-blue-200 hover:bg-blue-50 transition">
                                            <i class="fa-solid fa-eye mr-1"></i> View
                                        </a>
                                    <?php endif; ?>
